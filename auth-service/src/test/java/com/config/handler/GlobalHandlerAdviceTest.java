...
import com.config.util.MockEntity;
...
class GlobalHandlerAdviceTest {
  ...
  private static final String ENTITY_ALREADY_EXISTS_MESSAGE =
      "MockEntity with " + MOCK_ENTITY_ID + " already exists";
  ...
  void handleEntityAlreadyExistsException_shouldReturnConflictStatus() {
    var exception =
        new EntityAlreadyExistsException(MockEntity.class, String.valueOf(MOCK_ENTITY_ID));
