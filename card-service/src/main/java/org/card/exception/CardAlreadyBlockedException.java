package org.card.exception;

import org.springframework.http.HttpStatus;

public class CardAlreadyBlockedException extends AbstractExceptionMessageException {
  private static final String EXCEPTION_MESSAGE = "%s with ID %s already blocked";
  private static final String EXCEPTION_MESSAGE_WITH_FIELD = "%s with '%s' already blocked";
   ...
   */
  public <T> CardAlreadyBlockedException(Class<T> entity, Long id) {
   ...
   */
  public <T> CardAlreadyBlockedException(Class<T> entity, String fieldValue) {
